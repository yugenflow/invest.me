    ...
    <>
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          Join thousands of smart investors on Invest.me
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <button
          type="button"
          onClick={() => toast("Apple signup coming soon!")}
          className="flex items-center justify-center p-3 border border-gray-200 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
        >
      ...
      <p className="text-sm text-center text-gray-500 dark:text-gray-400">
        Have an account?{" "}
        <Link href="/login" className="text-brand-lime hover:underline font-semibold">
          Sign in instead
        </Link>
      </p>
    </>
